...
export const ElexaContext = React.createContext({
    userStats: { username: 'Commander' },
    partyState: { id: 'solo_1', members: ['Commander', 'Ironwall', 'Shadowblade', 'Lifeweaver'], roles: {} },
    raidState: { active: true, target: 'Citadel of Shadows', link: '#', current: 4500, goal: 10000 },
    handleAction: () => { }
});
